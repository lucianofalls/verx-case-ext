package br.com.verx.cashflow.consolidation.adapters.in.security;
    ...
    SecurityFilterChain securedFilterChain(HttpSecurity http,
        ...
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/v1/merchants/*/daily-balances/*")
                        .hasAuthority("SCOPE_balances:read")
